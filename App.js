  ...
  return (
    ...
    <div className="App">
      ...
      <div className="image-container">
       <img src="https://res.cloudinary.com/ccbpashokrock/image/upload/v1661076955/image-removebg-preview_9_1_1_mmpqby.png" alt="images-text" className="image"/>
       </div>
       </div>

       <div className="top-section">
          <div className="blog-container shadow">
              <img src="https://res.cloudinary.com/ccbpashokrock/image/upload/v1661233795/image-removebg-preview_53_1_mtz1ba.png" alt="text" className="images" />
              <img src="https://res.cloudinary.com/ccbpashokrock/image/upload/v1661233795/image_6_cbrgiy.png" alt="text" className="images" />
              <img src="https://res.cloudinary.com/ccbpashokrock/image/upload/v1661233795/image-removebg-preview_7_1_xejppz.png" alt="text" className="images" />
              <img src="https://res.cloudinary.com/ccbpashokrock/image/upload/v1661233795/image-removebg-preview_8_1_bpjt2i.png" alt="text" className="images" />
          </div>
       </div>

       <div className="middle-section">
       <img src="https://res.cloudinary.com/ccbpashokrock/image/upload/v1661234998/image_7_ijsji9.png" alt="text" className="image-1" />
       ...
       <div className="benefits-section">
        ...
        <div className="car-insurance-page-bottom-section">
          
             <div className="card shadow">
                    <div className="card-description">
                        <p className="description-title">Get a Car Insurance
                        <br/><span className="span-element">and use you brakes to meet us.</span></p>
                    </div>
                    <div className="button-container">
                        <button className="button-1" type="button">Apply Now</button>
                    </div>
              </div>
        </div>
